...
Alpine.store("contractAddress", CONTRACT_ADDRESS_POLYGON_MAIN);
Alpine.store("contractAbi", escrowCAbi);
Alpine.store("Network", "Polygon");
...
async function connect() {
  ...
  // request connection to polygon mainnet
  web3
    .request({
...
async function makeDeposit(amount) {
  try {
    ...
    console.log("making deposit of " + amount);
    ...
    // TODO
    var depositIndex = tx_receipt.events[1].args[2]['_hex']; // check debug_list
